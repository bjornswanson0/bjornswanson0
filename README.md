...
Edina, Minnesota roots → UMN Carlson School of Management (MIS) → strategy & AI consulting at Accenture.

By day I help big companies figure out what's next. On nights and weekends I ship small, handmade websites — plain HTML, CSS, and coffee.

## Live on the internet right now

| | Project | The story |
|---|---------|-----------|
| 🌐 | **[Personal site](https://bjornswanson0.github.io/)** | Roots, journey, and what's next — my corner of the web · [repo](https://github.com/bjornswanson0/bjornswanson0.github.io) |
